...
export default function Main() {
    return (
        <main className="bg-white dark:bg-gray-800 dark:text-white py-8 px-8 pl-12 h-full flex-1 overflow-y-scroll">
            <a href="https://ramonoliveira.dev" target="_blank" rel="noopener noreferrer" className="text-sm border-b-0 fixed right-8 z-10 dark:bg-gray-800 bottom-0 bg-gray-100 dark:border-gray-600 border-gray-300 border px-2 py-1 rounded-tl-md rounded-tr-md opacity-30 hover:opacity-100 transition-all duration-300 shadow-xl">
