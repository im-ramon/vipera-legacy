...
import { GrHomeRounded, GrMap, GrPieChart } from "react-icons/gr";
        ...
        <aside className="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
            <div className="flex items-center justify-center h-14 border-b">
                <div className='flex items-center justify-center'>
                    <Image className='w-10' id='logo' src={logo} alt='Dan Abramov' />
                    <strong className='font-handwrite'>Vipera</strong>
                </div>
            </div>
